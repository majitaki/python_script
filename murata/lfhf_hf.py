...
ax1 = trim_data['LF_HF'].plot(marker = 'o', label = 'LF_HF', fontsize=15)
ax2 = ax1.twinx()
ax2 = trim_data['HF'].plot(marker = 'o', label = 'HF', fontsize=15, style = ['r--', 'b.-'])

ax1.set_xlabel('time', fontsize = 15)
ax1.set_ylabel('LF_HF', fontsize = 15)
ax2.set_ylabel('HF', fontsize = 15)

ax1.set_title(sj_name + '_' + 'LFHF' + '_vs_' +  'HF', fontsize = 15)
...
#plt.tight_layout()
output_image_path = output_folder + sj_name + '_lfhf_hf' +'.png'
