...
graph_list = ['temp', 'ccvTP', 'HF_Norm', 'LF+HF']
imgs = []
...
for index, clm in  tqdm(zip(range(0, len(graph_list)), graph_list)):
    ...
    #plt.tight_layout()
    output_image_path = output_folder + sj_name + '_noize_' + clm +'.png'
...
cv2.imwrite(output_folder + 'output_compare_all_norm_noize' + sj_name + '.png', united_imgs)